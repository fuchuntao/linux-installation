...
//		scheduler.start();//初始化bean并启动scheduler
    ...
    public Properties quartzProperties() throws IOException {
		...
		prop.put("org.quartz.dataSource.quartzDataSource.URL", "jdbc:mysql://127.0.0.1：3306/task?useUnicode=true&characterEncoding=utf-8&useSSL=false&allowMultiQueries=true");
		prop.put("org.quartz.dataSource.quartzDataSource.user", "task");
		prop.put("org.quartz.dataSource.quartzDataSource.password", "QK4t6n23yMtPOViK");
