    ...
    public static JSONObject sendMediaByUrl(String fileType,String url,String token) {
  		...
  		jsonobject = null;
  			...
  			try{
				...
				sb.append("Content-Disposition: form-data;media=@media.file;name=\"file\";filename=\""+ valuename + "\"\r\n;title=图片标题;introduction=INTRODUCTION");
  			    sb.append("Content-Type:application/octet-stream\r\n\r\n");
  			    byte[] head = sb.toString().getBytes("utf-8");
  			    // 获得输出流
  			    out = new DataOutputStream(con.getOutputStream());
