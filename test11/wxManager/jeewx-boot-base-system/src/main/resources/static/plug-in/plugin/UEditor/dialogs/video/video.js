...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        createPreviewVideo: function(url){
            ...
            //     return;
            // }
            $("#eduiVideoPreview", me.$widget)[0].innerHTML ='<video class="edui-faked-video"  pluginspage="http://www.macromedia.com/go/getflashplayer"' +
                ' src="' + url + '"' +
                'style="width:420rpx;height:280rpx" controls="controls" />';
