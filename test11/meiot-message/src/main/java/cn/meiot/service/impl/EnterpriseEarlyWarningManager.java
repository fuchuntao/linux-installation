...
@Slf4j
@Component
public class EnterpriseEarlyWarningManager implements AlarmVoManager {
    ...
    public void push(AlarmVo alarmVo) {
        ...
        for (AlarmVo.Event e : events) {
            ...
            enterpriseUserFaultMsgAlarm.setEvent(EarlyWarning.get(e.getEvent()));
            ...
            enterpriseUserFaultMsgAlarm.setMsgContent(deviceAlias + "   " + switchAlias + FaultMsgContentEnum.getContent(EarlyWarning.get(e.getEvent())));
            enterpriseUserFaultMsgAlarm.setSwitchIndex(alarmVo.getSwitchInfo().getIndex());
            enterpriseUserFaultMsgAlarm.setSwitchStatus(1);
            enterpriseUserFaultMsgAlarm.setType(2);
